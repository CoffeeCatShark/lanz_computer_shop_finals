...
<body>
    <div class="confirmation-container">
        <div class="confirmation-header">
            <h2><i class="fas fa-exclamation-triangle"></i> Remove Active Request?</h2>
        </div>
        
        <form class="confirmation-form" action="remove-confirm-active.php" method="post">
            <div class="form-row">
                <label>ID:</label>
            ...
            <div class="form-row">
                ...
                <input type="hidden" value="<?= htmlspecialchars($activeIndex) ?>" name="index">
            </div>
            ...
            <div class="form-actions">
                ...
                <a href="admin-activedisplay.php" class="btn btn-secondary">
